...
# paras
W_conv1 = weight_varible([11, 11, 1, 48])
...
# conv layer-2
W_conv2 = weight_varible([5, 5, 48, 128])
...
# conv layer-3
W_conv3 = weight_varible([3, 3, 128, 192])
...
# conv layer-4
W_conv4 = weight_varible([3, 3, 192, 192])
b_conv4 = bias_variable([192])

h_conv4 = tf.nn.relu(conv2d(h_pool3, W_conv4) + b_conv4)

# conv layer-5
W_conv5 = weight_varible([3, 3, 192, 128])
...
# fully-connect-1
W_fc1 = weight_varible([16 * 8 * 128, 2048])
b_fc1 = bias_variable([2048])

h_pool5_flat = tf.reshape(h_pool5, [-1, 16 * 8 * 128])
h_fc1 = tf.nn.relu(tf.matmul(h_pool5_flat, W_fc1) + b_fc1)

# fully-connect-2
W_fc2 = weight_varible([2048, 512])
